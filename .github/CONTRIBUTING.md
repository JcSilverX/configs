...
`SILX` has adopted the [Contributor Covenant](https://www.contributor-covenant.org/) as its Code of Conduct, and we expect project participants to adhere to it.

Please read [the full text](/CODE_OF_CONDUCT.md) so that you can understand what actions will and will not be tolerated.

## Questions

If you have any questions, you can ask in our [GitHub Discussions - Q&A](https://github.com/silx/configs/discussions/categories/q-a).

## Monorepo

The monorepos within the `SILX` ecosystem use `pnpm` workspaces.

## How to Contribute

There are many ways to contribute to the project.

- **Support**: Help others in the community by answering questions in [GitHub Discussions - Q&A](https://github.com/silx/configs/discussions/categories/q-a) or providing solutions for others in [open issues](https://github.com/silx/configs/issues).

- **Ideas**: Share your ideas in [GitHub Discussions - Ideas](https://github.com/silx/configs/discussions/categories/ideas) for new features or improvements. We welcome suggestions that can enhance the project.

- **Report**: Report bugs or anything that is not working as expected by creating an [issue](https://github.com/silx/configs/issues).
...
```sh
cd configs
git remote add upstream https://github.com/silx/configs.git
```
...
8. Go to [the repository](https://github.com/silx/configs.git) and create a [Pull Request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request)
